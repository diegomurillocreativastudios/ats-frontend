      ...
      <div className={`${cardClass} border-vo-purple/30`}>
        ...
        {isLoading ? (
          ...
          <div className="mt-3 flex flex-col gap-3">
            <p className="rounded-md border border-emerald-700 bg-emerald-50 px-3 py-2 text-emerald-700 dark:bg-emerald-700">
          ...
          <div className="mt-3 flex flex-col gap-3">
            <p className="rounded-md border border-amber-700 bg-amber-50 px-3 py-2 text-amber-700 dark:bg-amber-700">
              {calendarEvent
