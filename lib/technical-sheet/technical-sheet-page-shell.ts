...
export function buildTechnicalSheetPageHtml(options: TechnicalSheetPageShellOptions): string {
  ...
  return `<section class="technical-sheet-page" style="width:${TECHNICAL_SHEET_PAGE_WIDTH_PX}px;height:${TECHNICAL_SHEET_PAGE_HEIGHT_PX}px;max-width:100%;margin:0 auto 16px;position:relative;overflow:hidden;box-sizing:border-box;background:#FBFAF7;box-shadow:0 14px 40px rgba(0,0,0,0.16);page-break-after:always;">
  <div class="technical-sheet-page__decor" aria-hidden="true" style="position:absolute;inset:0;pointer-events:none;z-index:1;overflow:hidden;">
    <div style="position:absolute;top:0;left:365px;width:76px;height:28px;background:#A45C40;"></div>
    <div style="position:absolute;top:0;right:0;width:86px;height:152px;background:#A45C40;"></div>
    <div style="position:absolute;top:0;right:0;width:54px;height:45px;background:#B87333;"></div>
    <div style="position:absolute;top:139px;right:0;width:15px;height:47px;background:#B87333;"></div>
    <div style="position:absolute;top:762px;right:0;width:28px;height:78px;background:#A45C40;"></div>
    <div style="position:absolute;bottom:58px;left:0;width:78px;height:126px;background:#A45C40;"></div>
    <div style="position:absolute;bottom:58px;left:0;width:50px;height:46px;background:#B87333;"></div>
    <div style="position:absolute;bottom:76px;right:12px;display:grid;grid-template-columns:repeat(4,10px);gap:18px 16px;">
      ${Array(16)
        .fill(
          '<span style="width:7px;height:7px;border-radius:50%;background:#A45C40;display:block;"></span>'
        )
        .join("")}
    </div>
    <div style="position:absolute;bottom:0;left:0;right:0;height:58px;background:#202124;"></div>
  </div>
  <header class="technical-sheet-page__header" style="position:relative;z-index:5;display:grid;grid-template-columns:430px 1fr;column-gap:35px;align-items:start;padding:62px 72px 0 20px;box-sizing:border-box;background:#FBFAF7;">
    <div style="display:flex;align-items:center;gap:14px;">
      <img src="${logo}" alt="" width="105" style="width:105px;height:auto;display:block;object-fit:contain;" />
      <div style="line-height:1;">
        <div style="font-size:34px;font-weight:800;letter-spacing:-1px;color:#3D3E41;font-family:Arial,Helvetica,sans-serif;">${escapeHtmlForTechnicalSheet(APP_NAME)}</div>
    ...
    <div style="font-size:12px;line-height:1.45;color:#202124;white-space:nowrap;padding-top:13px;">
