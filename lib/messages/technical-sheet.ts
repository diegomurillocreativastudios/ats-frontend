...
export const technicalSheetMessages = {
  ...
  pdfExportFailed:
    "No se pudo generar el PDF. Probá de nuevo o abrí la consola del navegador (F12) si el problema continúa.",
  doubleSubmitHint: "Esperá a que termine la descarga.",
  emptyPreview: "No hay secciones para mostrar.",
  generatedAt: "Documento generado",
  workExperience: "Experiencia laboral",
  workRolePerformed: "Cargo desempeñado",
  workPeriod: "Periodo",
  workMainFunctions: "Funciones principales",
